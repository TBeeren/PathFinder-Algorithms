					...
					public Base::Observer
	{
		public:
			...
			void setSpeed( float aNewSpeed,
						   bool aNotifyObservers = true);
			/**
			 * @brief Get the value of the compass orientation, combined with processnoise.
			 * 
			 * @return float 
			 */\
			 ...
			 */
			std::vector<float> ActivateLidarBeam(const Point& rCurrentPos);
			/**
			 * @brief 
			 * 
			 * @param nParticles 
			 ...
			 */
			std::vector<Point> GenerateRandomParticles(int nParticles);
			/**
			 *
			 ...
			 *
			 */
			PathAlgorithm::Path getKalmanPath()
			{
				return m_kalmanPath;
			}
			/**
			 *
			 */
			PathAlgorithm::Path getParticlePath()
			{
			 ...
			 *
			 */
			static bool KalmanActivated;
			/**
			 *
			 */
			static bool ParticleActivated;
		...
		private:
			...
			std::shared_ptr<CModel> m_spBeliefModel;
			std::shared_ptr<CEnvironment> m_spEnvironment;
			std::shared_ptr<CController> m_spController;

			std::vector<Point> m_particles;

			PathAlgorithm::Path m_kalmanPath;
			PathAlgorithm::Path m_particlePath;

...
namespace Model
{
	 ...
	 * 
	 */
	void RobotWorld::setPos(const Point& pos)
	{
	    m_robotPos = pos;
	}
	/**
	 *
	 */
	const Point& RobotWorld::getPos() const
	{
		return m_robotPos;
	}
	/**
	...
	void RobotWorld::populate( int aNumberOfWalls /*= 2*/)
	{
		...
		// Create borders for the world
		RobotWorld::getRobotWorld().newWall( Point(ROBOT_MIN_POS_X, ROBOT_MIN_POS_Y), Point(ROBOT_MAX_POS_X, ROBOT_MIN_POS_Y) ,false);
		RobotWorld::getRobotWorld().newWall( Point(ROBOT_MIN_POS_X, ROBOT_MAX_POS_Y), Point(ROBOT_MAX_POS_X, ROBOT_MAX_POS_Y) ,false);
		RobotWorld::getRobotWorld().newWall( Point(ROBOT_MIN_POS_X, ROBOT_MIN_POS_Y), Point(ROBOT_MIN_POS_X, ROBOT_MAX_POS_Y) ,false);
		RobotWorld::getRobotWorld().newWall( Point(ROBOT_MAX_POS_X, ROBOT_MIN_POS_Y), Point(ROBOT_MAX_POS_X, ROBOT_MAX_POS_Y) ,false);

		// Populate four walls in the world
		RobotWorld::getRobotWorld().newWall( Point(1,250), Point(600,250) ,false);
		RobotWorld::getRobotWorld().newWall( Point(500,500), Point(1023,500) ,false);
		RobotWorld::getRobotWorld().newWall( Point(50,510), Point(440,750) ,false);
		RobotWorld::getRobotWorld().newWall( Point(450,750), Point(950,950) ,false);

		// Populate the goal
		RobotWorld::getRobotWorld().newGoal( "Goal", Point(800,600),false);
